                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('user-password.update') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="current_password" type="password" class="form-control @error('current_password', 'updatePassword') is-invalid @enderror" name="current_password" autocomplete="current-password" required autofocus>
